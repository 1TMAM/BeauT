...
class ApplePaymentModel  extends BaseMappable{
  bool status;
  String errNum;
  String msg;
  Data data;

  ApplePaymentModel({this.status, this.errNum, this.msg, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return ApplePaymentModel(status: status,msg: msg,errNum: errNum,data: data);
  }
}

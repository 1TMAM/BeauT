...
class SearchByCategoryResponse extends BaseMappable {
  bool status;
  String errNum;
  String msg;
  Data data;

  SearchByCategoryResponse({this.status, this.errNum, this.msg, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return SearchByCategoryResponse(
        msg: msg, errNum: errNum, status: status, data: data);
  }
}
...
class Data {
  String categoryName;
  int countBeautician;
  List<BeauticianServices> beauticianServices;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['beautician_services'] != null) {
      beauticianServices = new List<BeauticianServices>();
      json['beautician_services'].forEach((v) {
        beauticianServices.add(new BeauticianServices.fromJson(v));
      });
    }
  }

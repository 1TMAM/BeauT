                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.symmetric(
                                                vertical: 10),
                                            child: ListView.builder(
                                                itemCount: data.paymentMethods[index].card.length,
                                                shrinkWrap: true,
                                                physics:
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                  ...
                                                                  child:Column(
                                                                    children: [
                                                                      Text(
                                                                        "${data.paymentMethods[index].card[indexx].holderName}",
                                                                        style: TextStyle(
                                                                            fontWeight:
                                                                            FontWeight
                                                                                .bold,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        const EdgeInsets
                                                                            ...
                                                                            30),
                                                                        child: Text(
                                                                          "${data.paymentMethods[index].card[indexx].number}",
                                                                          style: TextStyle(
                                                                              fontSize: 13),
                                                                        ),
                                                                      ),
                                                                  ...
                                                                  Navigator.push(
                                                                      ...
                                                                      MaterialPageRoute(
                                                                          builder: (context) => EditCard(
                                                                            card: data.paymentMethods[index].card[indexx],
                                                                          )));
                                                                },
                                                                child: Text(
                                                                  translator

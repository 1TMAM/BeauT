...
//        sink.add(email);
  ...
  var contactListValidator = StreamTransformer<List<String>,List<String>>.fromHandlers(
  ...
  var nothingFile = StreamTransformer<File,File>.fromHandlers(
  ...
  var codeValidator = StreamTransformer<String,String>.fromHandlers(
      handleData: (num , sink){
        if(num.length > 3){
          sink.add(num);
        }else{
